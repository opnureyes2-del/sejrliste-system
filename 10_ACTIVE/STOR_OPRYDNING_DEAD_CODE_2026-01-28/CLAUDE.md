...
| | |
|---|---|
| **Opgave** | STOR_OPRYDNING_DEAD_CODE_2026-01-28 |
| **Pass** | 1/3 |
| **Blokeret af** | Faerdiggoer Pass 1 (31/40 done) |
| **Sidst opdateret** | 2026-01-30 00:24 |
...
**Sektion:** D. STALE DATA OPRYDNING
**Linje:** 77 i SEJR_LISTE.md
...
Du maa IKKE:
- Arbejde paa andre opgaver end "STOR_OPRYDNING_DEAD_CODE_2026-01-28"
- Skippe "**D1.** Ryd op i `~/.collective_memory/` (378 MB, sidst ændret 21. jan)"
- Starte nye features foer denne checkbox er afkrydset
- Sige "det er faerdigt" uden at afkrydse checkbox

Du SKAL:
- Fokusere KUN paa: **D1.** Ryd op i `~/.collective_memory/` (378 MB, sidst ændret 21. jan)
...
- [ ] Jeg arbejder paa: **STOR_OPRYDNING_DEAD_CODE_2026-01-28**
- [ ] Min naeste handling er: ****D1.** Ryd op i `~/.collective_memory/` (378 MB, ...**
- [ ] Jeg er paa Pass: **1**
...
1. Arbejde paa andet end "STOR_OPRYDNING_DEAD_CODE_2026-01-28"
...
1. Afkryds `- [ ]` til `- [x]` i SEJR_LISTE.md linje 77
2. Koer: `python scripts/build_claude_context.py --sejr "STOR_OPRYDNING_DEAD_CODE_2026-01-28"`
...
> Du er her for at faerdiggoere **STOR_OPRYDNING_DEAD_CODE_2026-01-28**.
> Din naeste handling er ****D1.** Ryd op i `~/.collective_memory/`...**.
> Intet andet. Fokuser. Eksekver. Bevis.

---

**Auto-genereret:** 2026-01-30T00:24:00.373881+01:00
