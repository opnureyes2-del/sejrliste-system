...
def learn_from_completed(system_path: Path):
 ...
 print(f"[AI] Learning from {len(completed_sejr)} completed sejr...\n")
 ...
 print(f"[DATA] Extracted from {len(all_sejr_data)} sejr:")
 ...
 if patterns:
 print(f"[DATA] Identified {len(patterns)} new patterns:")
 for p in patterns:
 print(f" • {p['pattern']}")
 print()
