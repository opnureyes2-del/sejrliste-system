...
- [ ] Previous projects søgt: `grep "{KEYWORDS}"`
...
# 🔍 PASS 1 → PASS 2 REVIEW (OBLIGATORISK)
...
1. [ ] _problem 1_ → _løsning_
2. [ ] _problem 2_ → _løsning_
3. [ ] _problem 3_ → _løsning_
...
- [ ] Inline comments tilføjet: _ja/nej_
- [ ] Usage examples tilføjet: _ja/nej_
...
### PASS 2 SCORE: ___/10 (SKAL være > PASS 1 score)

**Tid brugt på Pass 2:** _{TID}_
**Forbedring fra Pass 1:** _{BESKRIVELSE}_

---

# 🔍 PASS 2 → PASS 3 REVIEW (OBLIGATORISK)
...
# ✅ FINAL VERIFICATION (OBLIGATORISK - 300% FÆRDIGT)
...
### PASS 3 SCORE: ___/10 (SKAL være > PASS 2 score)

**Tid brugt på Pass 3:** _{TID}_

---

# 📊 3-PASS KONKURRENCE RESULTAT
...
# 🏆 SEMANTISK KONKLUSION (Kun Når PASS 3 Komplet)
...
can_archive: false  # Bliver ALDRIG true før alle 3 passes er done
total_score: null
total_time: null
```
