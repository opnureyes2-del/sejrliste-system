...
class EnforcementState:
 ...
 LOCKED = "[LOCK] LOCKED" # Cannot start - prerequisites not met
 AVAILABLE = "[WARN] AVAILABLE" # Can be started
 IN_PROGRESS = "[ACTIVE] IN PROGRESS" # Currently working
 PENDING_VERIFY = "[WARN] PENDING" # Done but needs verification
 VERIFIED = "[OK] VERIFIED" # Verified and complete
 BLOCKED = "[BLOCKED] BLOCKED" # Blocked by failed verification
...
class EnforcementEngine:
 ...
 return False, f"[BLOCKED] BLOKERET: Checkpoint {checkpoint_id} findes ikke"
 ...
 return False, f"[BLOCKED] BLOKERET: Afhængighed {dep_id} er ikke færdig. FÆRDIGGØR DEN FØRST!"
 ...
 return False, f"[BLOCKED] BLOKERET: Du SKAL først færdiggøre: {', '.join(self.skipped_checkpoints)}"
 ...
 return False, f"[BLOCKED] BLOKERET: Kan ikke springe {cp.state} checkpoint over"
 ...
 lines = []
 lines.append("═" * 70)
 lines.append(" [TARGET] ENFORCEMENT TIMELINE")
 lines.append("═" * 70)
