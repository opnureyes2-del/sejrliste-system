...
class StatusIndicator:
    ...
    def get_icon(status: str) -> str:
        ...
        icons = {
            ...
            "at_risk": f"{Colors.YELLOW}⚠️{Colors.RESET}",
...
class SessionTimer:
    ...
    def render(self, width: int = 30) -> str:
        ...
        return f"⏱️ Session: {elapsed} {status}"
...
class StatisticsView:
    ...
    def render(self, width: int = 50) -> str:
        ...
        lines.append("=" * width)
        lines.append("")
        lines.append(f"  ✅ Sejr Completed:    {stats['sejr_completed']}")
        ...
        lines.append(f"  ⏱️  Time Saved:        {stats['time_saved_estimate']}")
        lines.append("")
        lines.append("=" * width)
